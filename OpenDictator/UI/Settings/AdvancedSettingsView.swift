...
struct AdvancedSettingsView: View {
    ...
    private var appDataDir: URL {
        ...
        return appSupport.appendingPathComponent("OpenDictator", isDirectory: true)
    }
            ...
            VStack(spacing: SettingsTheme.spacing16) {
                ...
                SettingsCard {
                    HStack(spacing: 14) {
                        ...
                        VStack(spacing: 8) {
                            Button {
                                NSWorkspace.shared.open(URL(string: "https://github.com/julian0xff/OpenDictator")!)
                            } label: {
                            ...
                            Button {
                                NSWorkspace.shared.open(URL(string: "https://github.com/julian0xff/OpenDictator/releases")!)
                            } label: {
